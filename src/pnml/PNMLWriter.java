...
public final class PNMLWriter {
    ...
    /**
     * Diese Methode fügt eine neue Edge zum XML Dokument hinzu. Vor dieser Methode muss
     * startXMLDocument() aufgerufen worden sein.
     * 
     * @param id
     *      Indentifikationstext der Stelle
     * @param source
     *      Indentifikationstext des Startelements der Edge
     * @param target
     *      Indentifikationstext der Endelements der Edge
     */
